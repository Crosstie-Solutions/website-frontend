...
function AboutUsPage() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-start gap-3 pb-5 bg-white large:mt-12 text-15px large:w-100vw large:h-auto small:w-100vw small:h-auto small:mt-8">
