...
function SalesExcellencePage() {
    ...
    const {currentPrograms, handleProgramsPageChange, currentProgramsPage, totalProgramsPages, programsSearchTerm,  programsStartIndex, programsEndIndex, allPrograms, allCourses, downloadScreen, toggleDownloadScreen, downloadProgramScreen} = useContext(CrossContext);
