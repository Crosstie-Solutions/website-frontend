      ...
      <div className='flex flex-col h-auto gap-0.5 w-100 p-1'>
        ...
        <div className='flex flex-row h-auto gap-5 w-100'>
            ...
            <div className='flex items-center justify-between h-auto w-100 large:flex-row small:flex-col small:gap-3 large:gap-0'>
                ...
                {/* Transformation */}
                <div className='flex flex-col justify-start gap-1 py-1 px-1 bg-white border border-crossIconBg large:w-30 h-auto text-15px rounded-20 small:w-100 pb-5'>
                    ...
                    <p className='text-crossTextGray'>We are dedicated to providing transformational change for our clients, helping them attain growth that seems unreachable and achieve their goals.</p>                
                </div>
                 ...
                 <div className='flex flex-col justify-start gap-1 py-1 px-1 bg-white border border-crossIconBg large:w-30 h-auto text-15px rounded-20 small:w-100 pb-5'>
                    ...
                    <p className='text-crossTextGray'>We strive for excellence in all aspects of our work, delivering high quality services that exceed client expectations.</p>                
                </div>  


                {/* Experience */}
                <div className='flex flex-col justify-center gap-1 py-1 px-1 bg-white border border-crossIconBg large:w-30 h-auto text-15px rounded-20 small:w-100'>
                    ...
                    <p className='text-crossTextGray'>We prioritize providing an exceptional experience for our clients, employees, and partners, striving to exceed expectations and build long-lasting relationships based on trust and mutual respect.</p>                
                </div>               
