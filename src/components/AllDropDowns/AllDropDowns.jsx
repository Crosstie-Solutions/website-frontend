...
function AboutDD() {
  ...
  return (
    <div className='fixed z-20 flex flex-col h-auto gap-1 px-1 py-2 bg-white border rounded shadow-lg w-250px large:top-15 large:left-25vw text-15px small:top-10 small:left-2'
    ref={dropdownRef}
...
return (
  <div className='fixed z-20 flex flex-col h-auto gap-1 px-1 py-2 bg-white border rounded shadow-lg w-250px large:top-13 large:left-35vw text-15px small:top-12 small:left-2'
  ref={dropdownRef}
...
return (
  <div className={`fixed z-20 flex flex-col h-auto gap-1 px-1 py-2 bg-white border rounded shadow-lg w-250px large:top-13 large:left-45vw text-15px ${navCourses ? "small:top-13 small:left-10vw" : "small:top-15 small:left-2"}`}
  ref={dropdownRef}
