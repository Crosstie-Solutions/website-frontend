...
function TopBar() {
  return (
    <div className='flex justify-center large:gap-4 small:gap-2 text-vogueWhite large:h-68px w-100 bg-crossDarkPurple large:text-20px small:text-13px border-t-crossDarkPurple small:h-40px'>
      ...
      <a href={`tel:09160901017`} className="flex items-center justify-center large:w-20 large:gap-1 large:ml-2 small:text-11px large:text-18px"><FaPhone className='rotate-90 text-20px'/> +234 916 090 1017</a>
