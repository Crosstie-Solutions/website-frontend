  ...
  return (
    <div className='flex flex-col items-center h-auto gap-2 w-100'>
      <div className='flex items-center h-auto gap-5 w-100'>
        <h4 className="self-start text-crossLightPurple small:hidden large:block">Training Enquiries({allEnquiries && allEnquiries.length})</h4>
      ...
      <div className='flex flex-col h-auto gap-1 w-100 large:text-15px small:text-13px'>
        ...
        <div className='flex justify-between h-auto gap-2 border-b border-gray-200 large:font-semibold small:font-semibold w-100'>
            ...
            <div className='w-20 large:relative text-vogueRed small:hidden large:flex'>Email</div>
            <div className='w-20 large:relative small:hidden large:flex'>Type</div>
        </div>

        {
            currentEnquiries && currentEnquiries.map((enquiry, i)=>
                <div className={`flex items-center justify-between h-auto w-100 ${i % 2 === 0 ? "bg-gray-100" : "bg-white"} pl-1 py-1 gap-2`}>
                    ...
                    <div className='relative small:right-2 large:w-20'>{enquiry.program}</div>
                    <div className='relative small:right-1 large:w-20'>{enquiry.phone}</div>
                    
                    <div className={`relative  small:right-1 text-vogueRed large:w-20 small:hidden large:flex`}>{enquiry.email.slice(0, 10)}...</div>

                    <div className={`relative small:right-1 large:w-20 small:hidden large:flex`}>{enquiry.userType}</div>
