...
function AdminReportAction(post) {

    const { postEnd, progNo, postId, title } = post;
  ...
  return (
    <div className='fixed top-0 left-0 z-20 flex flex-col items-center justify-center h-100vh w-100vw bg-overlay'>
        ...
        onClick={() => toggleAdminReportAction('sdsffdf')}
        />
...
export default AdminReportAction;
