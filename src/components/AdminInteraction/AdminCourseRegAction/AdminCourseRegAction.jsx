...
function AdminCourseRegAction(reg) {

    const { regNo, regEnd, regId, program, nameOfOrg, mode, participants, location, preferredDate, designation, title, fullName, email, phone, message, duration } = reg;
  ...
  return (
    <div className='absolute top-0 left-0 z-20 flex flex-col items-center justify-center h-auto py-10 w-100vw bg-overlay'>
        ...
        onClick={() => toggleAdminCourseRegAction('sdsffdf')}
        />
      ...
      <div className='flex flex-col items-center justify-center h-auto px-2 py-5 bg-white large:gap-3 large:w-60vw rounded-10 small:w-90vw small:gap-1'>
        ...
        <h2 className='font-semibold text-20px'>Course Registration</h2>
...
export default AdminCourseRegAction;