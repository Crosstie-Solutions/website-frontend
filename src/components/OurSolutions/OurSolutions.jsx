...
function OurSolutions() {
  ...
  return (
    ...
    <div className='flex flex-col h-auto gap-3 w-100'>
        <div className='flex flex-row justify-around h-auto gap-2 py-1 border w-70 rounded-3xl border-crossIconBg'>
            <button className={`w-auto text-15px ${solution==="Training Programmes" ? "bg-crossLightPurple text-white" : "bg-[#E7E7E7] text-crossTextGray"}  h-40px px-2 rounded-20`}
            onClick={()=>setSolution("Training Programmes")}
            >Training Programmes</button>
            
            <button className={`w-auto text-15px ${solution==="Consulting Services" ? "bg-crossLightPurple text-white" : "bg-[#E7E7E7] text-crossTextGray"}  h-40px px-2 rounded-20`}
            onClick={()=>setSolution("Consulting Services")}
            >Consulting Services</button>
            
            <button className={`w-auto text-15px ${solution==="High-demand Courses" ? "bg-crossLightPurple text-white" : "bg-[#E7E7E7] text-crossTextGray"}  h-40px px-2 rounded-20`}
