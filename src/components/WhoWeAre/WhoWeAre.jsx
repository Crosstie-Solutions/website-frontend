        ...
        <div className='flex flex-row h-auto gap-5 w-100'>
            ...
            <div className='flex items-center justify-between h-auto w-100 large:flex-row small:flex-col small:gap-3 large:gap-0'>
                ...
                <div className='flex flex-col justify-center gap-2 p-2 bg-white border border-crossIconBg large:w-30 h-300px text-15px rounded-20 small:w-100'>
                    ...
                    <p className='text-13px text-crossTextGray'>To be the trusted professional service brand chosen by organizations aiming to optimize talents and strategies for sustainable business growth.</p>                
                </div>
                ...
                <div className='flex flex-col justify-center gap-2 p-2 bg-white border border-crossIconBg large:w-30 h-300px text-15px rounded-20 small:w-100'>
                    ...
                    <p className='text-13px text-crossTextGray'>To optimize talents and strategies for sustainable business growth through specialized competency-based development and management consulting solutions.</p>                
                </div>   
            </div>
