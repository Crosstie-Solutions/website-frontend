...
function WebinarFeedbackFilter() {

    const {webinarFeedbackSearchTerm, setWebinarFeedbackSearchTerm} = useContext(CrossContext);
  ...
  return (
    <div className="flex flex-row items-center gap-1 p-1 border-2 border-crossTextGray rounded-10 h-100 w-100 text-15px">
        ...
        <input
          ...
          value={webinarFeedbackSearchTerm}
          onChange={(e) => {
            setWebinarFeedbackSearchTerm(e.target.value);
